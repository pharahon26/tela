                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () => setState(() {
                            _flash = !_flash;
                            _flash? _cameraController.setFlashMode(FlashMode.torch) : _cameraController.setFlashMode(FlashMode.off);
                          }),
                          icon: Icon(_flash? Icons.flash_on: Icons.flash_off, color: _flash? Colors.yellow : Colors.grey),
                        ),
                      ],
                    ),
                    Padding(
