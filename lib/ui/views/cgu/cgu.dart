...
import 'package:mobile/ui/views/cgu/cguViewModel.dart';
import 'package:stacked/stacked.dart';

class ConditionGeneralDUtilisationS extends StatefulWidget {
  const ConditionGeneralDUtilisationS({super.key});

  @override
  State<ConditionGeneralDUtilisationS> createState() => _ConditionGeneralDUtilisationSState();
}

class _ConditionGeneralDUtilisationSState extends State<ConditionGeneralDUtilisationS> {

  String title = "L'APPLICATION ET LES CONDITIONS GENERALES D'UTILISATION";
  bool lapp_vu = true;
  String lapp = "I- L' APPLICATION";
  String lapp_body = """TELA est une application 3 en 1 qui comporte les services:
...
par TELA.""";
  ...
  String immo_ar1 = """Le démarcheur ou la demarcheuse est celui ou celle qui, après s'être inscrit et payé son
...
chaque fois que ses photos seront consultées.""";
  ...
  String immo_ar2 = """Le visiteur est celui qui pour effectuer la recherche d'un logement ou d'un bureau paye
des visites avant de consulter les photos de la plateforme.""";
  String immo_ar3_t = "Article 3";
  String immo_ar3 = """Le démarcheur ou la demarcheuse s'abonne selon les types d'abonnements suivants:
- abonnement basic (5000 FCFA)
- abonnement medium (15.000 FCFA)
- abonnement premium (30.000 FCFA).""";
  String immo_ar4_t = "Article 4";
  String immo_ar4 = """Ces trois types d'abonnements sont rémunérés respectivement selon les taux suivants:
...
- abonnement prémium : 25% du montant de la visite.""";
  ...
  String immo_ar5 = """La configuration des photos à télécharger par le démarcheur ou la demarcheuse:
...
fonction du nombre du jours du mois.)""";
  ...
  String immo_ar8 = """Pour être rémunéré les mois suivants, le démarcheur ou la démarcheuse devra se
réabonner entre le 24 et le 26 pour le mois de février et entre le 26 et 28 pour les autres
mois.""";
  String immo_ar9_t = "Articles 9";
  String immo_ar9 = """Une fois les délais de réabonnement passés, le démarcheur ou la démarcheuse a deux
options :
...
5000 + 2500 = 7500 F""";
  ...
  String immo_ar10 = """Les dates de réabonnement mentionnées ci-dessus ne concernent pas le premier mois
d'abonnement vu que le ou la démarcheuse n’a pas perçu son solde du premier mois.""";
  String immo_ar11_t = "Article 11";
  String immo_ar11 = """Le visiteur, pour consulter les logements ou bureaux disponibles sur la plateforme devra
payer:
...
5 000 F CFA pour consulter les photos de 20 maisons.""";
  ...
  String fin_ar1 = """Pour disposer d'un espace personnel sur TELA Finance, l'abonné(e) devra remplir tous
...
photo de profil, photocopie de la carte nationale d’identité -CNI- ou du passeport)""";
  ...
  String fin_ar2 = """L'abonné(e) dispose d'un espace personnel et confidentiel pour accéder, à son espace
personnel.""";
...
via mobile money ou carte bancaire.""";
  ...
  String fin_ar6 = """L'abonné(e) ne peut débiter son espace personnel de l'entièreté des fonds. Un montant
...
dans le but d'acheter un service sur la plateforme.""";
  ...
  String fin_ar8 = """La demande de relevé est soumise à des frais : 500 FCFA""";
  String fin_ar9_t = "Articles 9";
  String fin_ar9 = """La mise à jour du solde peut connaître un retard de 24h au maximum""";
  String fin_ar10_t = "Article 10";
  String fin_ar10 = """Les déplacements de fonds effectués par l'abonné(e) entre son compte courant et son
...
d'obtenir son espace personnel sur TELA finance.""";
  ...
  String tv_ar4 = """Après abonnement, le téléspectateur verra son espace personnel crédité du montant de
son gain 24h plutard.""";
  String tv_ar5_t = "Article 5";
  String tv_ar5 = """Le téléspectateur verra son compte courant crédité de 80% du montant de son gain et
son compte épargne crédité de 20% du montant de son gain.""";
  bool ex_vu = true;
  String ex = "D- LES EXCEPTIONS";
  String ex_ar1_t = "Article 1";
  String ex_ar1 = """Les frais sur les retraits peuvent varier selon les taux proposés à nous, par notre
prestataire.""";
  String ex_ar2_t = "Article 2";
  String ex_ar2 = """Les pourcentages sur les types d'abonnement peuvent connaître des modifications.""";
  String ex_ar3_t = "Article 3";
  String ex_ar3 = """Les pass visiteurs peuvent aussi connaître des modifications.""";
  String ex_ar4_t = "Article 4";
  String ex_ar4 = """En cas d'application des trois articles susmentionnés, les abonnés et les visiteurs
