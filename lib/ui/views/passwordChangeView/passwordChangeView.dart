  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<PasswordChangeViewModel>.reactive(
        ...
        builder: (context, model, child) => Scaffold(
              appBar: AppBar(
                title: const Text('Modification', style: TextStyle(color: Colors.white)),
                centerTitle: true,
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffix: IconButton(
                                    ...
                                    icon: Icon(isPasswordVisible1? Icons.visibility_outlined : Icons.visibility_off_outlined , color: isPasswordVisible1? Theme.of(context).colorScheme.primary : Colors.black,),
